...
const config = {
  entry: {
    ...
    snake: { import: path.join(__dirname, "src/snake/index.js"), filename: "snake/[name].js" },
    blog: { import: path.join(__dirname, "src/blog/index.ts"), filename: "blog/[name].js" },
    form: { import: path.join(__dirname, "src/blog/form/form.ts"), filename: "blog/[name].js" },
    todolist: {
